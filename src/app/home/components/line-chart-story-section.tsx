...
const LineChartStorySection = () => {
  ...
  return (
    <section className="mx-auto flex w-full max-w-[1536px] flex-col gap-20 px-6 md:-mt-20 md:flex-row md:gap-6 md:px-14 lg:mt-0 lg:gap-10 xl:px-[13.5rem] 2xl:gap-20">
